...
const Works = () => {
    return (
        <section id='works'>
            ...
            <span className="worksDesc">I take pride in paying attention to detail.</span>
            <div className="worksImgs">
                ...
                <a href="https://github.com/jagtapshubham2112/ecommerce" target="_blank" rel="noopener noreferrer">
